		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mdg Partner Mandatory Attachments",
									"targetURL": "#comsmurfitwestrockmdgmandattch-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmurfitwestrockmdgmandattch-display": {
								"semanticObject": "comsmurfitwestrockmdgmandattch",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smurfitwestrock.mdg.mandattch",
									"url": sap.ui.require.toUrl("com/smurfitwestrock/mdg/mandattch")
								}
							}
						}
					}
